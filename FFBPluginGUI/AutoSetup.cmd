...
"%BUILDER%" -t:restore FFBPluginGUI.sln /p:Platform=x64;Configuration=%BuildMode% -p:RestorePackagesConfig=true 
:: Build
::"%BUILDER%"  Dinput8Wrapper.sln  /maxcpucount:1 /t:clean /p:Platform=x64;Configuration=%BuildMode%
"%BUILDER%"  FFBPluginGUI.sln  /maxcpucount:4  /p:Platform=x64;Configuration=%BuildMode%

:build86
:: Restore nuget packages
"%BUILDER%" -t:restore FFBPluginGUI.sln /p:Platform=x86;Configuration=%BuildMode% -p:RestorePackagesConfig=true 
:: Build
::"%BUILDER%"  Dinput8Wrapper.sln  /maxcpucount:1 /t:clean /p:Platform=x86;Configuration=%BuildMode%
"%BUILDER%"  FFBPluginGUI.sln  /maxcpucount:4  /p:Platform=x86;Configuration=%BuildMode%
